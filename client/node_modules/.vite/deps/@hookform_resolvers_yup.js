import {
  o,
  s
} from "./chunk-2TQHPQTR.js";
import {
  appendErrors
} from "./chunk-5LVAHBB5.js";
import "./chunk-ZPYW2SYB.js";
import "./chunk-4B2QHNJT.js";

// node_modules/@hookform/resolvers/yup/dist/yup.mjs
function o2(o3, n, s2) {
  return void 0 === n && (n = {}), void 0 === s2 && (s2 = {}), function(a, i, c) {
    try {
      return Promise.resolve(function(t, r) {
        try {
          var u = (n.context && true && console.warn("You should not used the yup options context. Please, use the 'useForm' context object instead"), Promise.resolve(o3["sync" === s2.mode ? "validateSync" : "validate"](a, Object.assign({ abortEarly: false }, n, { context: i }))).then(function(t2) {
